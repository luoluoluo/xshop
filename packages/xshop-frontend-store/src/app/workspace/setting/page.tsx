...
import { updateMe, createUserWechatMerchant } from "@/requests/auth.client";
...
const PaymentSetting = ({
  ...
  const isEditable = me.wechatMerchantStatus !== WechatMerchantStatus.Completed;
