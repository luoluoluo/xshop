    ...
    <div className="relative flex min-h-screen flex-col">
      ...
      <main className="flex-1 container">
        <section className="flex max-w-full flex-col px-4 py-16 lg:py-24 mx-auto items-center gap-2 text-center">
          <h1
            className="font-bold tracking-tighter lg:leading-[1.1] text-2xl lg:text-4xl animate-fade-up"
            style={{ animationDelay: "0.2s", animationFillMode: "both" }}
          >
            {setting.title}
          </h1>
          <p
            className="mt-4 text-muted-foreground text-base lg:text-lg max-w-full animate-fade-up"
